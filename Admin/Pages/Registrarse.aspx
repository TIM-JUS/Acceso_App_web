...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="container box">
        <h1 class="title">Registro de usuarios Timoteo</h1>

        <div class="field">
            <label class="label">Nombre</label>
            <div class="control">
                <asp:TextBox runat="server" ID="nombre" CssClass="input" type="text" placeholder="kenyi timoteo"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <asp:TextBox runat="server" ID="edad" CssClass="input" type="text" placeholder="18"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <asp:TextBox runat="server" ID="usuario" CssClass="input" type="text" placeholder="kenyi_timoteo_justo"></asp:TextBox>
            </div>
        </div>
